...
function draw() {
 ...
 function keyPressed(){
	 if(keyCode === UP_ARROW){
		...
		Matter.Body.applyForce(bobObject2.body,bobObject1.body.position,{x:-50,y:-45});
		Matter.Body.applyForce(bobObject3.body,bobObject1.body.position,{x:-50,y:-45});
		Matter.Body.applyForce(bobObject4.body,bobObject1.body.position,{x:-50,y:-45});
